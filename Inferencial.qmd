...
where:
 - $\hat{p}$ is the observed proportion of heads
 - $z$ is the critical value from the standard normal distribution for a 95% confidence level (approximately 1.96)
...
*Is it reasonable to conclude that this is a fair coin with 95% confidence? *
Based on this narrower confidence interval, it appears less likely that the coin is fair since $p = 0.5$ is not within the interval.
